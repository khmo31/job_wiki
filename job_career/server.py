"""
Flask 서버: 백엔드 crewAI와 프론트엔드 UI를 연결합니다.
"""
...
# Debug: show which Python started this server
print("현재 사용 중인 파이썬 경로:", sys.executable)
print("현재 파이썬 버전:", sys.version)

# Prefer a dedicated Python executable for running batch jobs if available.
# You can override by setting the environment variable JOB_CAREER_PYTHON.
DEFAULT_CONDA_PY = Path(r"C:/Users/khmo/miniconda3/envs/job_career/python.exe")
PY_EXEC = os.getenv("JOB_CAREER_PYTHON") or (str(DEFAULT_CONDA_PY) if DEFAULT_CONDA_PY.exists() else sys.executable)
print("배치용 Python 실행기:", PY_EXEC)
# 프로젝트 루트
...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print("커리어 판단 에이전트 - Flask 서버")
    print("=" * 80)
    print(f"\n서버 시작: http://localhost:{port}")
    print("프론트엔드: http://localhost:5000/static/index.html")
